...
/opt/rubystack-2.2.5-3/ruby/bin/ruby channel_scraper.rb whereistheboom.html whereistheboom.csv
/opt/rubystack-2.2.5-3/ruby/bin/ruby channel_summary.rb whereistheboom.csv whereistheboom_summary.csv

/opt/rubystack-2.2.5-3/ruby/bin/ruby channel_scraper.rb yementodaychannl.html yementodaychannl.csv
